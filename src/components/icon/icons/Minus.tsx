...
export default function Minus(props: React.SVGProps<SVGSVGElement>): JSX.Element {
    return (
        <svg viewBox="0 0 25 25" version="1.1" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="Icon-Set-Filled" transform="translate(-469.000000, -1041.000000)" fill="var(--haze-color-0)">
