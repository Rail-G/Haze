...
export default function Mail(props: React.SVGProps<SVGSVGElement>): React.ReactNode {
    return (
        <svg fill="#000000" viewBox="0 -2.04 16 16" id="mail-16px" xmlns="http://www.w3.org/2000/svg" {...props}>
